...
const Home = () => {
  ...
  const images = [
    "https://via.placeholder.com/1200x800/FF5733/FFFFFF?text=Slide+1",
    "https://via.placeholder.com/1200x800/337AB7/FFFFFF?text=Slide+2",
    "https://via.placeholder.com/1200x800/28A745/FFFFFF?text=Slide+3",
  ];
  ...
  const ResourceItem = ({ title, description }) => (
    <div className="flex flex-col items-center p-4 bg-white rounded-full shadow-md w-48">
    ...
    const resources = [
      { title: 'Digital E-Books', description: 'Free For All book order' },
      { title: "Teacher's Resource Manual", description: 'Free For All book order' },
      { title: 'Test Paper Generator', description: 'Free For All Book order' },
      { title: 'LED/TV Video Content', description: 'Free For All Book order' },
    ];
  ...
  return (
        ...
        <div className="absolute inset-0 flex items-center pl-10">
          <div className="text-left text-white z-10">
            <h1 className="text-4xl md:text-6xl font-bold mb-4">
              Welcome to Oliver Publications
            </h1>
            <p className="text-lg md:text-xl mb-6">
              Empowering the future with creativity, innovation, and quality.
            </p>
            <a
              href="#about"
    ...
    <div className="bg-gray-100 p-8 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-32 bg-blue-100 rounded-b-full"></div>
      
      <div className="relative z-10">
        <div className="flex justify-center space-x-8 mb-8">
          {resources.map((resource, index) => (
            <ResourceItem key={index} title={resource.title} description={resource.description} />
          ))}
        </div>
      </div>
      
      <div className="absolute top-4 left-4">
        <img src="/api/placeholder/50/50" alt="Teddy bear" className="transform -rotate-12" />
      </div>
      <div className="absolute top-8 left-16">
        <img src="/api/placeholder/50/30" alt="Red book" className="transform rotate-12" />
      </div>
      <div className="absolute bottom-4 right-4">
        <img src="/api/placeholder/100/60" alt="Stack of books" />
      </div>
    </div>
